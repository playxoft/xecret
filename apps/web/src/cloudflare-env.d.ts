/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv src/cloudflare-env.d.ts` (hash: d8e06e0e442cf2878a5750b323418f00)
// Runtime types generated with workerd@1.20260804.1 2026-08-05 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	ASSETS: Fetcher;
	XECRET_ENV: "production" | "staging" | "development";
	XECRET_PUBLIC_URL: "https://xecret.playxoft.com" | "https://xecret-staging.playxoft.com" | "http://localhost:3000";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "XECRET_ENV" | "XECRET_PUBLIC_URL">> {}
}
